                ...
                <div className="custom-padding relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-24 mb-24">
                        ...
                        <div className="grid  gap-8 lg:px-10">
                            <div className="space-y-10">
                                <h4 className="text-white font-black uppercase text-sm tracking-[0.3em]">{t('footer.quick_explore')}</h4>
                        ...
                        <div className="space-y-10">
                            <h4 className="text-white font-black uppercase text-sm tracking-[0.3em]">{t('footer.subscribe.title')}</h4>
